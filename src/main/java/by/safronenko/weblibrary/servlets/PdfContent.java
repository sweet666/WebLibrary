 ...
 */
package by.safronenko.weblibrary.servlets;

import by.safronenko.weblibrary.objects.LibraryFacade;
...
public class PdfContent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //Если save true - книга сохраняется, если false - открывается для чтения
